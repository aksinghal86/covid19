---
title: "Projections using Generalized Richards Model"
...
**Confirmed cases**
```{r}
cases <- read.delim('../data/covid-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv', 
...
deaths <- read.delim('../data/covid-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv', 
                           sep = ',', header = TRUE, stringsAsFactors = FALSE) %>%
  rename(country = Country.Region, province = Province.State, lat = Lat, lon = Long) 
